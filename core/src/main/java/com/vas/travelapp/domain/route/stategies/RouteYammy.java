...
public class RouteYammy implements RouteStrategy {

    private static final Set<Integer> POINT_TYPES =
            Set.of(PointType.NO_TYPE.ordinal(), PointType.CAFE.ordinal(), PointType.RESTAURANT.ordinal(), PointType.BAR.ordinal(), PointType.STROLL.ordinal());

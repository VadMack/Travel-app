...
public class RouteFamily implements RouteStrategy {

    private static final Set<Integer> POINT_TYPES =
            Set.of(PointType.NO_TYPE.ordinal(), PointType.CAFE.ordinal(), PointType.EVENT.ordinal(), PointType.MUSEUM.ordinal(), PointType.STROLL.ordinal());
